    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return FadeInAnimation(
          ...
          child: _buildMatchCard(user, match.timestamp),
        );
      },
    );
  }

  Widget _buildMatchCard(User user, DateTime matchTime) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return FadeInAnimation(
          ...
          child: _buildMessageListItem(user, messageProvider),
        );
      },
    );
  }

  Widget _buildMessageListItem(User user, MessageProvider messageProvider) {
